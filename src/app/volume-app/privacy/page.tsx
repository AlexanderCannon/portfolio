  ...
  return (
    <main className="bg-[#F5F1E8] px-4 py-14 text-[#132C4B]">
      <article className="prose prose-slate mx-auto max-w-3xl prose-headings:font-serif prose-headings:text-[#132C4B] prose-a:text-[#0f766e] prose-a:no-underline hover:prose-a:underline">
        <h1>Privacy policy — VOLUME</h1>
        <p className="lead text-[#6D7785]">
          <strong>Effective date:</strong> May 13, 2026. This policy describes the VOLUME mobile application and related pages at{" "}
          <Link href="/volume-app">alexandercannon.dev/volume-app</Link>. The operator is Alexander Cannon (&quot;we&quot;,
          &quot;us&quot;).
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            may call Google Books to return metadata (title, authors, cover, page count). Queries may be cached briefly server-side to
            improve performance and reduce duplicate upstream calls.
          </li>
          <li>
            <strong>Diagnostics and product analytics.</strong> The app may emit basic analytics events during development; production
            analytics depend on configuration. This marketing site may use cookies or similar technologies as described in the main
            site experience when you browse these pages.
          </li>
        </ul>
        ...
        <p>We use service providers that process data on our instructions, including:</p>
        <ul>
        ...
        <p>
          ...
          <Link href="/contact">contact form</Link> on this site and mention &quot;VOLUME&quot; in your message.
        </p>
        <p>
          <Link href="/volume-app/terms">Terms of service</Link> · <Link href="/volume-app">VOLUME home</Link>
        </p>
      </article>
    </main>
  );
