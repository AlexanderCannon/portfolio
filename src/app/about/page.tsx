    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="mb-12 text-center">
        ...
        <div className="flex justify-center gap-4">
          ...
          <a href="#" className="flex items-center gap-2 text-purple-600 hover:text-blue-800">
            <FaGithub size={20} />
            <span>GitHub</span>
          </a>
          <a href="#" className="flex items-center gap-2 text-purple-600 hover:text-blue-800">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-blue-500 dark:to-purple-500 p-4 rounded-lg ">
            <h3 className="text-xl font-semibold mb-2">Enterprise AI Solutions</h3>
            <p className="text-gray-700 dark:text-gray-300">Led the development of LLM-based AI tools for enterprise applications, focusing on scalability and performance optimization.</p>
          </div>
          <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-blue-500 dark:to-purple-500 p-4 rounded-lg ">
            <h3 className="text-xl font-semibold mb-2">Fintech Innovation</h3>
            <p className="text-gray-700 dark:text-gray-300">Founded and launched a regulated fintech application, implementing complex financial systems and obtaining banking licenses.</p>
          </div>
          <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-blue-500 dark:to-purple-500 p-4 rounded-lg ">
            <h3 className="text-xl font-semibold mb-2">Streaming Platform</h3>
            <p className="text-gray-700 dark:text-gray-300">Developed Discovery Network&apos;s first online streaming platform, supporting live Olympic events for millions of viewers.</p>
          </div>
          <div className="bg-gradient-to-r from-gray-50 to-gray-50 dark:from-blue-500 dark:to-purple-500 p-4 rounded-lg ">
            <h3 className="text-xl font-semibold mb-2">Blockchain Development</h3>
            <p className="text-gray-700 dark:text-gray-300">Created multiple crypto tokens and ICOs, building surrounding web applications with modern tech stacks.</p>
          </div>
        </div>
      </section>
    </div>
